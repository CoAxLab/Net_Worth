%format4anova3.m
% Formats the subject data for/performs rmanova2.m
...
save('exp3_anova_data.mat', 'subj_labels','rp_labels','sv_labels',...
...
% Do the ANOVAs
responses = rm_anova2(mean_response,subj_labels,rp_labels,sv_labels,{'prob','sv'})

sl_risky = rm_anova2(mean_slxn_err_risky,subj_labels2,rp_labels2,sv_labels2,{'prob','sv'})
sl_safe = rm_anova2(mean_slxn_err_safe,subj_labels2,rp_labels2,sv_labels2,{'prob','sv'})

rt_risky = rm_anova2(mean_rt_risky,subj_labels2,rp_labels2,sv_labels2,{'prob','sv'})
rt_safe = rm_anova2(mean_rt_safe,subj_labels2,rp_labels2,sv_labels2,{'prob','sv'})

pV_risky = rm_anova2(mean_peak_V_risky,subj_labels2,rp_labels2,sv_labels2,{'prob','sv'})
pV_safe = rm_anova2(mean_peak_V_safe,subj_labels2,rp_labels2,sv_labels2,{'prob','sv'})

diff_pV = rm_anova2(pv_diff, subj_labels2, rp_labels2, sv_labels2, {'prob','sv'})
diff_rt = rm_anova2(rt_diff, subj_labels2, rp_labels2, sv_labels2, {'prob','sv'})
diff_sl = rm_anova2(sl_diff, subj_labels2, rp_labels2, sv_labels2, {'prob','sv'})

save('exp3_anova_results.mat', 'responses','sl_risky','sl_safe','rt_risky','rt_safe'...
